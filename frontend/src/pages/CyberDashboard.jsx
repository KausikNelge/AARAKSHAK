...
const CyberDashboard = () => {
  ...
  const fetchMockBreachData = async () => {
    try {
              const response = await axios.get('https://aarakshak-backend.onrender.com/api/breach-check/test@example.com');
  ...
  const fetchMockVirusTotalData = async () => {
    try {
              const response = await axios.get('https://aarakshak-backend.onrender.com/api/virus-total/https://example.com');
  ...
  const fetchMockCloudSecurityData = async () => {
    try {
              const response = await axios.get('https://aarakshak-backend.onrender.com/api/cloud-security');
  ...
  const checkEmailBreach = async () => {
    ...
    try {
              const response = await axios.get(`https://aarakshak-backend.onrender.com/api/breach-check/${encodeURIComponent(emailToCheck)}`);
      setBreachData(response.data);
      toast.dismiss();
  ...
  const scanUrl = async () => {
    ...
    try {
              const response = await axios.get(`https://aarakshak-backend.onrender.com/api/virus-total/${encodeURIComponent(urlToScan)}`);
      setVirusTotalData(response.data);
      toast.dismiss();
